export default {
	"Events": [
		...
		},
		{
			...
			"patterns": [
				"[vixio] bot (login|connect) [seen by %-string%]"
			],
			"eventvalues": [
				"event-bot"
			],
		...
		},
		{
			...
			"patterns": [
				"button interaction receive[d] [seen by %-string%]"
			],
			"eventvalues": [
				"event-user",
				"event-messagechannel",
			...
			"examples": [
				"on button interaction received:"
			]
		},
		{
			...
			"patterns": [
				"select [menu] interaction receive[d] [seen by %-string%]"
			],
			"eventvalues": [
				"event-user",
				"event-messagechannel",
			...
			"examples": [
				"on select interaction received:"
			]
		},
		{
			...
			"patterns": [
				"slash command [interaction] receive[d] [seen by %-string%]"
			],
			"eventvalues": [
				"event-user",
				"event-messagechannel",
		...
		{
			"description": "Fired when a user leaves a guild. Could be caused by kicking them or them leaving on their own free will. This event only fires if you have the guild members intent enabled.",
			"name": "Guild Leave",
			"patterns": [
	...
	"Conditions": [
		...
		{
		"description": "This is for verified bots or bots that have enabled privileged intents and need to activate them in Vixio",
	...
	"Effects": [
		...
		{
		"description": "This is used specifically to enable specific gateway intents in the create bot scope. This must be done before you login to your bot and you must restart for changes to take effect.",
		...
		{
		"description": "This is for verified bots or bots that have enabled privileged intents and need to activate them in Vixio. The intents must be enabled before you login to your bot.",
		"name": "Login",
			"patterns": [
		...
		"name": "Acknowledge Interaction",
			"patterns": [
				"ack[nowledge] [the] interaction [event]"
			],
			"examples": [
				"on slash command received:",
	...
	"Expressions": [
		...
		"name": "Type of Channel",
			"patterns": [
				"[the] type[s] of %channels%",
				"%channels%'[s] topic[s]"
			],
			"examples": [
				"set type of event-channel to \"TEXT\" with event-bot"
			]
		},
		{
		...
		"name": "Name of",
			...
			"examples": [
				"broadcast \"%discord name of event-user%\""
			]
		},
		{
